...
const projects : Iproject[] = [
    {
    name : 'Fit-Focus', 
    description : 'A web app to do exercises and keep an active lifestyle, with a Personalized Routine, news, tips and more!. In this project i have worked building the backend.',
    ...
    {
     name:'Contacts-App',
     description : 'In this Web Application you can store your contacts, visualize them and edit. Authentication made with JWT Auth.',
